...
#func _enter_tree():
	#g.is_dialog_begin.emit()

#func _exit_tree():
	#g.is_dialog_ended.emit()
...
#func _process(_delta) -> void:
	#%CharacterLabel.modulate = g.name_color
...
func _on_balloon_gui_input(event: InputEvent) -> void:
	...
	if dialogue_label.is_typing and event is InputEventMouseButton and event.button_index == MOUSE_BUTTON_RIGHT and event.is_pressed():
		get_viewport().set_input_as_handled()
